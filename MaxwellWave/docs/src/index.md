...
![](./homogeneous_dirichlet_vecE_3D_epsilon.png)
![](./homogeneous_dirichlet_vecE_3D_sigma.png)
...
![](./homogeneous_dirichlet_vecE_3D_inituy.png)
![](./homogeneous_dirichlet_vecE_3D_sliceplty.gif)
...
![](./homogeneous_dirichlet_vecE_3D_slicepltx.gif)
![](./homogeneous_dirichlet_vecE_3D_initvy.png)
...
![](./absorbing_boundary_vecE_3D_epsilon.png)
![](./absorbing_boundary_vecE_3D_sigma.png)

The initial conditions are not changed:
![](./absorbing_boundary_vecE_3D_inituy.png)
![](./absorbing_boundary_vecE_3D_sliceplty.gif)

As in the previous example, we plot only the x/y-component:
![](./absorbing_boundary_vecE_3D_slicepltx.gif)
![](./absorbing_boundary_vecE_3D_initvy.png)
...
![](./nonlinear_vecE_3D_epsilon.png)
![](./nonlinear_vecE_3D_sigma.png)
![](./nonlinear_vecE_3D_chi3.png)


The initial conditions are again not changed:
![](./nonlinear_vecE_3D_inituy.png)
![](./nonlinear_vecE_3D_sliceplty.gif)

We omit again the z-component, since even with nonlinear effect the coupling to the z-component is small. 
![](./nonlinear_vecE_3D_slicepltx.gif)
![](./nonlinear_vecE_3D_initvy.png)
